import { Avatar, Button, Card, CardContent, Dialog, DialogTitle, Divider, Typography, Zoom } from '@material-ui/core';
    ...
    return (
        ...
        >
            <div className={classes.container}>
                ...
                {showOptionsMenu && <OptionsMenu handleCloseOptionsMenu={handleCloseOptionsMenu}/>}
...
function ProfileNameSection({ user, isOwner, handleShowOptionsMenuClick }: any){
    const classes = useProfilePageStyles();
